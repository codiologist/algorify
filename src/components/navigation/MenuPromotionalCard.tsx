...
const Title: React.FC<TitleProps> = ({ className, children, ...rest }) => (
  <h2
    className={cn("text-2xl leading-tight font-semibold text-black", className)}
    {...rest}
  >
    {children}
  </h2>
...
const Description: React.FC<DescriptionProps> = ({
  ...
  <p
    className={cn(
      "text-justify text-[18px] leading-tight text-black",
      className,
    )}
    {...rest}
  >
    ...
    >
      <div className="max-w-sm overflow-hidden rounded-2xl bg-white shadow">
        ...
        <Link
          ...
          className="relative flex items-center justify-between gap-4 p-6 pb-4"
        >
